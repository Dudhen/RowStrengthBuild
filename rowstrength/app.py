...
S_INPUT = Pack(font_size=F_INPUT, margin_right=10)
...
class RowStrengthApp(toga.App):
    ...
    def startup(self):
        ...
        splash_box = toga.Box(
            ...
            # центрируем и по вертикали, и по горизонтали
            style=Pack(direction=COLUMN, alignment="center", align_items="center", flex=1, padding=40)
        )
